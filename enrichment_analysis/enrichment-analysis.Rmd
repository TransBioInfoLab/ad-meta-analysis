...
```{R load_db, eval = FALSE}
library("RnBeads")
dir <- downloadLolaDbs(".","LOLACore")
```

```{R LOLA_run, results = "hide", message = FALSE}
library(LOLA)
...
```{R LOLA_res, results = "hide", message = FALSE}
### All hyper regions
locResults <- runLOLA(
...
```{R LOLA_run2, results = "hide", message = FALSE}
### All hypo regions
locResults <- runLOLA(
...
```{R LOLA_single_run, results = "hide", message = FALSE}
...
```{R LOLA_single_res, results = "hide", message = FALSE}
