---
title: "Sensitivity analysis - inflation corrected meta-analysis using bacon method"
...
estimation_of_inflation <- function(data){
  ...
  # inflation factor
  print("Genomic Inflation factor by bacon method")
  print(inflation(bc))
  print(bias(bc))
...
# Meta analysis - after subjecting single CpG p-values to inflation correction by bacon method
