...
dmr_case <- dmr_case[,c(1:5, 23,9:22)]
dmr_case
```
...
dmr_control <- dmr_control[,c(1:2, 6:8, 23,9:22)]
dmr_control
```
...
cpg_case <- cpg_case[, c(1:5, 25, 15,17:24)]
cpg_case
```
...
cpg_control <- cpg_control[, c(1:2,6:8, 25, 15, 17:24)]
cpg_control
```
