...
qtestPerm <- quantro(object = beta_mat[complete.cases(beta_mat),],
                     ...
                     B = 1000)
stopCluster(cl)
save(qtestPerm,file = file.path(data.dir.probes.normalization,"PFC_qtestPerm.rda"))
```

```{R, include = FALSE}
load(file.path(data.dir.probes.normalization,"PFC_qtestPerm.rda"))
```

```{R}
qtestPerm

##### 2. Plot before normalization and BMIQ ####################################
### Density plot
...
matboxplot(beta_mat,
           groupFactor = pheno_df$stage,
           xaxt = "n",
           main = "Beta Values in London PFC cohort (autosomes) - before normalization")
...
matboxplot(betaQN,
           groupFactor = pheno_df$stage,
           xaxt = "n",
           main = "Beta Values in London PFC cohort (autosomes) - after normalization")
